...
def count_length():
    ...
    result_label.config(text=f"String Value: {result}")
...
label = Label(window, text="Enter Name:", font=("Helvetica", 12))
label.pack(pady=15)

entry = Entry(window, width=50, font=("Helvetica", 12))
entry.pack()
entry.bind('<Return>', on_enter_press) 

button = Button(window, text="Calculate", font=("Helvetica", 12), bg="#4CAF50", fg="white", padx=20, pady=10)
button.pack(pady=15)
